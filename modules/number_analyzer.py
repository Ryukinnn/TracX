...
class NumberAnalyzer:
    def analyze(self, phone):
        result = {'raw': phone, 'error': None, 'valid': False}
        try:
            ...
            # Perkiraan lokasi dari kode area (jika ada)
            location = geocoder.description_for_number(parsed, 'en')
            if location and location != result['country_name']:
                result['area_location'] = location
            return result
